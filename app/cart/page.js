...
export default function CartPage() {
  ...
  const cartItems = [
    { ...products[0], quantity: 1 }, // Wireless Headphones
    { ...products[3], quantity: 2 }, // Sunglasses
    { ...products[5], quantity: 1 }, // T-shirt
  ];
            ...
            <div className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="flex flex-col">
                {cartItems.map((item, index) => (
                  <div key={index} className="grid grid-cols-1 md:grid-cols-12 gap-4 p-6 border-b border-gray-100 items-center">
                    ...
                    <div className="col-span-1 md:col-span-6 flex items-center gap-4">
                      ...
                      <div className="flex flex-col">
                        <Link href={`/product/${item.id}`} className="font-bold text-lg text-gray-900 hover:text-[#1a56a8] transition-colors">
                          {item.title}
                        </Link>
                    ...
                    <div className="col-span-1 md:col-span-3 flex items-center md:justify-center mt-4 md:mt-0">
                      <div className="flex items-center border border-gray-200 rounded-lg bg-white h-10 w-28">
                        <button className="flex-1 flex justify-center items-center text-gray-500 hover:text-[#1a56a8] hover:bg-gray-50 h-full rounded-l-lg transition-colors">
                        ...
                        <button className="flex-1 flex justify-center items-center text-gray-500 hover:text-[#1a56a8] hover:bg-gray-50 h-full rounded-r-lg transition-colors">
